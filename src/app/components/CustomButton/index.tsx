...
const CustomButton = (props: CustomButtonProps) => {
  ...
  const { onPress, style, activeOpacity, icon, title, selected, iconStyle, disabled, textStyle, ...textProps } = props;
  return (
    <TouchableOpacity
      onPress={onPress}
      style={[styles.container, customStyles(), selected && styles.selected, style]}
